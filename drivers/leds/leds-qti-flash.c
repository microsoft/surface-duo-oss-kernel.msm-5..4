...
/* To differentiate and apply corresponding settings for Cronos */
#define CRS_PRODUCT_ID					4
#define IRES_12P5_MAX_CURR_MA_CRS		1500
#define MS_PER_LED_MAX_LIMIT_CRS		(IRES_12P5_MAX_CURR_MA_CRS / 2)
/* MSCHANGE end */
...
/* MSCHANGE start */
static const u32 flash_led_max_ires_values_crs[MAX_IRES_LEVELS] = {
	IRES_5P0_MAX_CURR_MA, IRES_12P5_MAX_CURR_MA_CRS
};
/* MSCHANGE end */
					...
					enum led_brightness brightness)
{
	...
	/* MSCHANGE start */
	/* Using product id to identify product and use properties correspondingly */
	if (s_product_id == CRS_PRODUCT_ID)
	{
		max_ires_value = flash_led_max_ires_values_crs[fnode->ires_idx];
		per_led_max_limit = MS_PER_LED_MAX_LIMIT_CRS;
	}
	else
	{
			...
			struct flash_node_data *fnode, struct device_node *node)
{
	...
	if (s_product_id == CRS_PRODUCT_ID)
	{
		ires_permissible_max_current = IRES_12P5_MAX_CURR_MA_CRS;
	}
	else
	{
