...
# MSCHANGE start, added SURFACE_PRODUCT_KEY_FRAG
SURFACE_PRODUCT_KEY_FRAG=${CONFIGS_DIR}/surface_product_key.config

export ARCH CROSS_COMPILE REAL_CC HOSTCC HOSTLD HOSTAR KERN_SRC KERN_OUT \
	CONFIGS_DIR BASE_DEFCONFIG QCOM_GKI_FRAG QCOM_QGKI_FRAG QCOM_DEBUG_FRAG SURFACE_PRODUCT_KEY_FRAG
# MSCHANGE end
